...
const SubHeader: React.FC<SubHeaderProps> = ({ steps, onStop, depth = 1, className = '', depth2Text = 'text' }) => {
  return (
    <div className={`w-full bg-white border-b border-gray200 relative ${className}`}>
      ...
      <div className="max-w-[1200px] mx-auto px-0 tablet:px-[20px] py-[16px]">
        <div className="h-[60px]">
          {depth === 1 ? (
            ...
            <>
              ...
              {/* Mobile view */}
              <div className="hidden tablet:flex absolute left-[20px] right-[20px] top-1/2 -translate-y-1/2 items-center">
                {onStop && (
                  <Button
                    color="white"
                    size="md"
            ...
            <>
              ...
              <div className="absolute left-[52px] top-1/2 -translate-y-1/2 flex items-center tablet:left-[20px]">
                ...
                <span className="ml-[12px] text-body1 font-semibold text-gray700 whitespace-nowrap tablet:hidden">
                  이전으로
                </span>
              </div>
