...
export const Modal: React.FC<ModalProps> = ({
  ...
  const getModalClasses = () => {
      if (isMobile) {
          return size === 'expanded' 
              ? 'w-[335px] max-w-[335px] p-8 flex flex-col justify-center items-start gap-5 border border-[#F0F1F6] rounded-[10px] bg-white shadow-[0_0_15px_0_rgba(167,167,167,0.10)]' 
              : 'w-[335px] max-w-[335px] p-8 flex flex-col justify-center items-start gap-5 border border-[#F0F1F6] rounded-[10px] bg-white shadow-[0_0_15px_0_rgba(167,167,167,0.10)]';
      }
      
      return size === 'expanded' 
          ? 'flex flex-col justify-center items-start w-[550px] px-7 py-8 gap-7 rounded-[10px] border border-[#F0F1F6] bg-white shadow-[0_0_15px_0_rgba(167,167,167,0.10)]' 
          : 'flex flex-col justify-center items-start w-[400px] min-w-[300px] max-w-[400px] px-7 py-8 gap-7 rounded-[10px] border border-[#F0F1F6] bg-white shadow-[0_0_15px_0_rgba(167,167,167,0.10)]';
  };
  ...
  const getTextAreaClasses = () => {
    if(isMobile) {
        return "w-full h-[120px] flex min-h-[100px] p-4 items-center gap-2 self-stretch rounded-small border border-gray400 bg-white outline-sky"
    }
    return "w-full h-[200px] flex min-h-[100px] p-4 items-center gap-2 self-stretch rounded-small border border-gray400 bg-white outline-sky"
  }
      ...
      <div className={getModalClasses()}>
          ...
          <div className="w-full flex items-center gap-2 self-stretch">
                <Button
                    ...
                    className="flex px-6 py-3.5 justify-center items-center gap-2 flex-1 rounded-small border border-gray400 bg-white100"
                >
                    {primaryButton.label}
                </Button>
              {secondaryButton && (
                <Button
                    ...
                    className="flex px-6 py-3.5 justify-center items-center gap-2 flex-1 rounded-small border border-gray400 bg-sky"
                >
